...
public class MainActivity extends AppCompatActivity {
    ...
    private static String url = "http://192.168.43.7/belajar-sholat/latihan/soal.php";
    ...
    protected void onCreate(Bundle savedInstanceState, View.OnClickListener klikSelesai, View.OnClickListener klikSebelum, View.OnClickListener klikBerikut) {
    ...
    private void showInputUser() {
        ...
        View v = mInflater.inflate( R.layout.activity_input_user, null );
    ...
    private View.OnClickListener klikSelesai = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert.setIcon( R.drawable.ic_baseline_account_circle_24 );
