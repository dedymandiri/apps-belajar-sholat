...
public class video_sholatashar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_sholatashar);

        //Inisialisasi VideoView, MediaController dan Button
        videoView = findViewById(R.id.videoashar);
        playVideo = findViewById(R.id.playashar);
        ...
        playVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.sholat_ashar);
